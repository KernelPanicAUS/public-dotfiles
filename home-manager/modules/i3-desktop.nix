{
  ...
  # i3 + Polybar desktop environment configuration
  # This module is specific to machines using i3 window manager
  ...
  config = lib.mkIf pkgs.stdenv.isLinux {
    ...
    xsession.windowManager.i3 = {
      ...
      config = {
        ...
        keybindings = lib.mkOptionDefault {
          ...
          "Mod4+Shift+q" = "exec ~/.local/bin/rofi-power-menu";
          ...
          # Clipboard manager
          "Mod4+v" = "exec clipmenu -p 'Clipboard'";

          # Power menu
          "Mod4+Shift+e" = "exec ~/.local/bin/rofi-power-menu";
    ...
    home.packages = with pkgs; [
      ...
      networkmanager_dmenu  # Rofi-based NetworkManager interface
    ];

    # Rofi power menu script
    home.file.".local/bin/rofi-power-menu".text = ''
      #!/usr/bin/env bash
    ...
    '';
    home.file.".local/bin/rofi-power-menu".executable = true;
  };
}
